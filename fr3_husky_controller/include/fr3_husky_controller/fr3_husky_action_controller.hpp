...
#include "fr3_husky_controller/fr3_husky_action_controller_parameters.hpp"
...
using fr3_husky_action_controller::ParamListener;
using fr3_husky_action_controller::Params;

namespace fr3_husky_controller 
{
class FR3HuskyActionController : public controller_interface::ControllerInterface 
{
